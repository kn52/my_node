  ...
  return(
    <>
      <h1>
        ...
        <span className={txtNum === "1" ? "h_d under_line" : "h_d not_under_line"} onClick={() => txtNumber("1")}>
            {props.location.hasOwnProperty("data") ? <>{props.location.data.dtls}!</> : "Stranger...!"}
        </span>
        <span className={txtNum === "2" ? "h_d under_line" : "h_d not_under_line"} onClick={() => txtNumber("2")}>
            Welcome Back
        </span>
      </h1>
    </>
